...
const AddMarksButton = (props) => {
  ...
  const onChangeHindi = (event) => {
    setAddHindi(parseInt(event.target.value));
  };
  const onChangeLabskills = (event) => {
    setAddLabskills(parseInt(event.target.value));
  };
  const onChangeIt = (event) => {
    setAddIt(parseInt(event.target.value));
  };
  const onChangeEnglish = (event) => {
    setAddEnglish(parseInt(event.target.value));
  };
  const onChangeTelugu = (event) => {
    setAddTelugu(parseInt(event.target.value));
  };
  const onChangeMaths = (event) => {
    setAddMaths(parseInt(event.target.value));
  };
  const onChangeScience = (event) => {
    setAddScience(parseInt(event.target.value));
  };
  const onChangeSocial = (event) => {
    setAddSocial(parseInt(event.target.value));
  };
